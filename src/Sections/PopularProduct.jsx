    ...
    <section id="products" className="max-container max-sm:mt-12 ">
      <div className=" flex flex-col justify-start gap-5">
        ...
        <p className="lg:max-w-lg mt-2 font-montserrat text-slate-grey ">
          These products, among others, have solidified Nike reputation for
          pushing boundaries in design, technology, and performance, while
          maintaining a cultural resonance that transcends generations.
        </p>
      </div>
